...
module MusicMaster
  ...
  module Processes
    ...
    class CutFirstSignal
      ...
      # * *:SilenceMin* (_String_): The minimal duration silence must have to be considered as splitting the first non-silent signal from the rest of the audio (either in seconds or in samples)
